...
<DataTable
  caption="Table 2. Naive difference-in-differences on Colorado housing values, using the simple unweighted average of all 49 other states as the control group."
  columns={[
    { key: 'group', label: 'Group', align: 'left' },
    { key: 'pre', label: 'Pre-2014 avg. ZHVI', align: 'left' },
    { key: 'post', label: 'Post-2014 avg. ZHVI', align: 'left' },
    { key: 'growth', label: 'Growth', align: 'left' },
  ]}
  rows={[
    { group: 'Colorado (treated)', pre: '$215,192', post: '$344,321', growth: '+60.0%' },
    { group: 'All other states (simple average)', pre: '$173,780', post: '$232,596', growth: '+33.9%' },
  ]}
/>
...
<Equation
  label="Naive DiD estimate, Colorado legalization"
  latex={String.raw`\text{Naive DiD} \;=\; 60.0\% - 33.9\% \;=\; 26.2\%`}
/>
...
<DataTable
  caption="Table 3. Naive DiD versus synthetic control on the same Colorado case. The synthetic control estimate replaces a flat average of 49 states with an optimized weighted twin fit to Colorado's own pre-treatment path."
  columns={[
    { key: 'method', label: 'Method', align: 'left' },
    { key: 'control', label: 'Control group construction', align: 'left' },
    { key: 'estimate', label: 'Estimated effect', align: 'left' },
  ]}
  rows={[
    { method: 'Naive DiD', control: 'Simple average of all 49 other states', estimate: '+26.2%' },
    { method: 'Synthetic control', control: "Optimized weighted blend of donor states, fit to Colorado's pre-trend", estimate: '+20.2%' },
  ]}
  highlightRow={1}
/>
