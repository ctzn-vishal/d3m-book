...
The rest of Part IV is the toolkit that makes that commitment operationally tractable: how to set up the prediction task (Chapter 9), how to evaluate the model on its business cost (Chapter 10), how to find structure when no label exists (Chapter 11), and how to turn the score into a repeatable customer decision that survives contact with production (Chapter 12).
