  ...
  rows={[
    {
      ...
      artefact: 'Decision Question Card (§5.1) plus targeting audience plan (§12.1).',
    },
    {
      section: 'Score',
      question: 'How well does the model rank, and at what threshold?',
      artefact: 'Model card (§10.5) and threshold–profit curve (§10.2).',
    },
    {
      section: 'Segments',
      question: 'Who are we targeting and why?',
      artefact: 'Segment profile small-multiples (§11.1).',
    },
    {
      section: 'Audience',
      question: 'How do segments map to media-buy and CRM audiences?',
      artefact: 'Audience plan with reach-similarity setting (§12.1).',
    },
    {
      section: 'Lift',
      question: 'What incremental impact do we expect, and how are we measuring it?',
      artefact: 'Holdout design and pre-registered KPI (§5.3, §12.1).',
    },
    {
      section: 'Monitoring',
      question: 'How will we know if it stops working?',
      artefact: 'Four-KPI dashboard and retraining trigger (§12.3).',
    },
    {
      section: 'Governance',
      question: 'Who owns it; what are the failure modes; how is the model audited?',
      artefact: 'Model card "known failure modes" and "owner" rows (§10.5).',
    },
  ]}
/>
...
The model card from [§10.5](/ch10-automl-explainability) appears again here because it is the artefact the rest of the loop depends on. Without it, the threshold is a number with no justification, the audience is a list with no rationale, and the monitoring is a dashboard with no contract to grade against.

<Figure width="page-outset" caption="Figure 2. The deployed model card for the Bean &amp; Basket churn model. Every row corresponds to a question the team will be asked at some point in the model's lifetime; the rows tie back to the artefacts produced across Chapters 9 and 15.">
  <div className="not-prose">
    <ModelCard />
  </div>
</Figure>
