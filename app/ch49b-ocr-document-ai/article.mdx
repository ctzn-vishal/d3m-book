...
4.  **LLM extraction.** A language model is given the OCR'd text + the layout, and a JSON schema describing what to extract. It returns structured fields. This is the §21.3 pattern applied to documents.
