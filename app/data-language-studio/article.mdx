...
<Callout variant="caveat" title="A chart deck is not a data brief">

**The brief starts too late.** If the first artifact is a dashboard screenshot, grain and metric decisions have already been made invisibly.

**The metric definition is verbal.** "Active customer" and "market share" sound clear until a denominator and window are written down.

**The join map is missing.** Without row-count and anti-join checks, a technically valid join can still inflate revenue or drop customers.
