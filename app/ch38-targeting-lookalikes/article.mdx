...
<Pitfall title="Audience contamination">
Showing the same user a conversion campaign and a retention campaign at once muddles attribution and wastes spend. **Enforce mutually exclusive audiences at the campaign level.**
</Pitfall>

<Pitfall title="Seed contamination">
If the seed for a lookalike mixes real high-value customers with noisy edge cases (employees, bots, accidental signups), the lookalike is diluted. The seed is the input feature; **clean it like one before building the audience.**
</Pitfall>

<Pitfall title="Over-trusting the platform's reporting">
Platforms grade their own homework. **Where independent measurement is feasible — uplift studies, hold-out audiences — use it.**
</Pitfall>
