...
<Pitfall title="Catalogue rot">
The index is built once, never updated, and within six months it's missing half the active artefacts. **Make a catalog entry a precondition for ship, and remove artefacts the moment they're deprecated.**
</Pitfall>

<Pitfall title="Owner-of-record vs. owner-of-fact">
The catalog lists Priya as owner; Priya rotated to a new team three months ago and nobody updated the index. **Tie ownership to a role, not a person, and run a quarterly catalog audit.**
</Pitfall>

<Pitfall title="Versioning by laptop">
Three slightly different versions of "the retention model" sit on three laptops. **Establish a single canonical location for every artefact, with clear pointers from the catalog.**
</Pitfall>
