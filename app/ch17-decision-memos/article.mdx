...
"Sales went up after the campaign" is a description, not a memo. **Make the §5.2 logic — what would have happened without the action — a non-optional section.**
</Pitfall>
...
The next article — §17.3 — moves from the single memo to the portfolio of memos and the operating cadence that runs across them.
