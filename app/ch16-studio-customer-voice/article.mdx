...
- [§17.1 The Data Product View](/ch17-data-product) — treating every artefact as a product with an owner, a version, and a contract.
- [§17.2 Decision Memos](/ch17-decision-memos) — the one-page document that integrates every form of evidence into a recommendation.
- [§17.3 Monitoring, Feedback, and Learning Loops](/ch17-learning-loops) — the portfolio-level operating cadence; how the two customer studios feed each other.
- [§17.4 The Final Integrative Case](/ch17-studio-final-case) — a Bean &amp; Basket strategic decision that uses every Part of the book at once.
