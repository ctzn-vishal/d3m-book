...
A **custom audience** is what you get when the firm hands the platform a list of its own customers (or website visitors, app users, CRM records) and asks to show ads only to those people. It is the operational form of the segmentations from [§11.1](/ch11-clustering).
...
Targeting on a modern ad platform is the operational form of everything in Chapter 11. Custom audiences are bring-your-own segments; lookalike audiences are nearest-neighbour scoring at scale, performed against features the platform sees and the firm does not.
