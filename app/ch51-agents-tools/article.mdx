...
3.  **Embed + cluster.** Tool: §19.2 embedding service + clustering. Surface the dominant complaint clusters.
...
6.  **Summarize.** Tool: LLM with structured output (§21.3). Generate a JSON record per emerging issue: topic, evidence quotes, severity, related tickets, suggested action.
