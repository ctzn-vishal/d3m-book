...
3.  **The interface is stable.** Structured outputs (§21.3) let the measurement return JSON that flows into the rest of the pipeline without manual cleanup.
...
<DataTable
  ...
  rows={[
    ...
    },
    {
      ...
      tool: 'Topic model (§18.5) or embedding clustering (§19.2)',
