...
- **Embedding-based clustering (§19.2)** of local review text to surface the dominant themes by market.
- **GPT-as-measurement (§19.3)** on the local review corpus, scoring constructs like "brand-as-third-place importance", "willingness to pay for premium", "loyalty to local independents", "convenience over experience."
