...
function renderPanel(data: DashboardStoryboardData, stageId: string) {
      ...
      <div className="grid min-h-[280px] gap-4 md:grid-cols-[1fr_1.2fr] md:items-center">
        <div className="rounded-md border border-border bg-white p-5">
          ...
          <div className="mt-3 flex items-end gap-2">
            ...
            <span className="mb-1 rounded-md bg-green-50 px-2 py-1 text-sm font-medium text-green-700">
              {data.kpi.change}
            </span>
          </div>
  ...
  if (stageId === 'trend') {
    return (
      <div className="h-[300px] rounded-md border border-border bg-white p-4">
  ...
  return (
    <div className="grid min-h-[280px] gap-3 md:grid-cols-3">
      {data.actions.map((action, index) => (
        <div key={action} className="rounded-md border border-border bg-white p-4">
          <div className="mb-3 inline-flex h-7 w-7 items-center justify-center rounded-md bg-emerald-50 text-sm font-semibold tabular-nums text-emerald-700">
            {index + 1}
          </div>
...
export function DashboardStoryboard({ data }: DashboardStoryboardProps) {
  ...
  return (
    <div className="not-prose my-8 overflow-hidden rounded-md border border-border bg-card shadow-sm">
      <div className="border-b border-border bg-white p-4 md:p-5">
      ...
      <div className="grid border-b border-border bg-white md:grid-cols-5">
          ...
          return (
            <button
              ...
              className={[
                ...
                selected
                  ? 'bg-body text-white'
                  : 'bg-white text-subtle hover:bg-code-bg',
              ].join(' ')}
            >
      ...
      <div className="p-4 md:p-6">
        ...
        <div className="mt-4 rounded-md border border-border bg-white p-4 text-sm leading-relaxed text-subtle">
