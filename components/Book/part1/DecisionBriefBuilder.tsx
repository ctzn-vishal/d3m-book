...
export function DecisionBriefBuilder({ data }: DecisionBriefBuilderProps) {
  ...
  return (
    <div className="not-prose my-8 overflow-hidden rounded-md border border-border bg-surface dark:shadow-none">
      <div className="grid lg:grid-cols-[300px_1fr]">
                ...
                <button
                  ...
                  className={[
                    ...
                    selected
                      ...
                      : 'border-transparent text-subtle hover:border-border hover:bg-surface dark:hover:bg-body/60',
                  ].join(' ')}
                >
                  <span className="mt-0.5 inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-md bg-surface text-xs font-semibold tabular-nums text-body ring-1 ring-border">
                    {index + 1}
                  </span>
        ...
        <div className="p-4 md:p-6">
          <div className="flex items-start gap-3">
            <span className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-accent/10 text-accent-ink">
          ...
          <div className="mt-5 grid gap-4 lg:grid-cols-[1fr_240px]">
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-md border border-accent/40 bg-accent/10 p-3">
                <div className="text-[11px] font-semibold uppercase tracking-wide text-accent-ink">
                  Red flag
                </div>
                <p className="mt-1 text-sm leading-snug text-accent-ink">
                  {active.red_flag}
                </p>
              </div>
            </div>
