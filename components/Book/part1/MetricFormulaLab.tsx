      ...
      <div className="grid gap-0 lg:grid-cols-[280px_1fr]">
                ...
                <button
                  ...
                  className={[
                    ...
                    selected
                      ...
                      : 'border-transparent bg-transparent text-subtle hover:border-border hover:bg-white',
                  ].join(' ')}
                >
        ...
        <div className="p-4 md:p-6">
          ...
          <div className="mt-6 rounded-md border border-border bg-white p-4">
            ...
            {active.denominator && (
              <div className="mt-3 rounded-md bg-body px-3 py-2 font-mono text-sm text-white">
                {active.formula}
              </div>
            )}
          </div>
