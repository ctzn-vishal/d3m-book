...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // /ch00-data-system. Both the pre-consolidation slugs and the four
      // per-section slugs 301 forward to it so inbound/indexed links survive.
      { source: '/ch00-1-what-is-d3m', destination: '/ch00-data-system', permanent: true },
      { source: '/ch00-2-evidence-stack', destination: '/ch00-data-system', permanent: true },
      { source: '/ch00-3-how-data-is-used', destination: '/ch00-data-system', permanent: true },
      { source: '/ch00-4-data-to-decision-loop', destination: '/ch00-data-system', permanent: true },
      { source: '/ch00-data-origins', destination: '/ch00-data-system', permanent: true },
